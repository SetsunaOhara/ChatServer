...
{
	//查询userid用户所加群组的群组id，群名称，群描述信息
	
	/*
	1. 先根据userid在groupuser表中查询出该用户所属的群组信息
	2. 在根据群组信息，查询属于该群组的所有用户userid，并且和user表进行多表联合查询，查出用户的详细信息
	*/
	char sql[1024] = { 0 };
	...
	vector<Group> groupVec;//存放userid加入的所有群组Group对象
	...
	//查询群组中的用户信息，完善Group的vector<GroupUser> users属性，把每个群组中的所有用户都添加进各自Group对象的users数组中
